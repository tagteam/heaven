...
[//]: ## Vignette about nested case control
...
## Does it work?
Of course you get less precision using nested case control compared to if you could do the analysis on the whole population rather than only on the cases and some sampled controls. But how much worse is nested case control really? We can try some simulations to check
