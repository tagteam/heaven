...
#'              "cancer","chronic_kidney_disease","copd","liver_disease","alcohol". See \link[=doc/halal_defs.pdf]{definitions of diseases}. 
...
#' inddto <- as.Date(sample(inddto,500000,replace=T),origin='1970-01-01')
#' uddto <- c(1:10)
