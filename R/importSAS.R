...
#'                  na.strings=c("dot"),date.vars=NULL,datetime.vars=NULL,
...
#' @param sas.switches On linux this defaults to \code{""} on any other system to \code{"-batch -nosplash -noenhancededitor -sysin"}
