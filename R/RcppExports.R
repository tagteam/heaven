...
Matcher <- function(Ncontrols, Tcontrols, Ncases, reuseControls, expWindow, startDate, controlIndex, caseIndex, controls, cases, Ndateterms, datescases, datescontrols, NoIndex, seed) {
    .Call('_heaven_Matcher', PACKAGE = 'heaven', Ncontrols, Tcontrols, Ncases, reuseControls, expWindow, startDate, controlIndex, caseIndex, controls, cases, Ndateterms, datescases, datescontrols, NoIndex, seed)
}
