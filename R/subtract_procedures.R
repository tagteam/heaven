...
#' @param time_frame An integer value setting time-window in number of days between procedures in 
...
subtract_procedures = function(data, time_frame=NULL, procedure=NULL, incombination=NULL, record.id = "RECNUM", procedure.codes = "OPR", out.date = "ODTO"){
  ...
  # Setting the default time_frame to be one day.
  ...
  if(is.null(incombination)){
    ...
    singular_ops <- test_data_difference[test_data_difference$time_difference > time_frame] 
  }
