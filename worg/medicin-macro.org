...
\begin{align} 
	  ...
	  &+ \, u_{k-1} \bigg[\tag{Overlap}
          \\ \begin{split}
 & \qquad   1\{S_{b(k-1)}= S_{b(k)}\}\bigg( \one \left\lbrace W_k > \smax_{b(k)}\right\rbrace \smax_{b(k)}
...
\noindent The following table show the final estimated daily doses for
...
#+RESULTS[<2016-11-21 14:32:34> c159a62d19174b9f7e100f1bc29ab9739eaf0fb7]:
:RESULTS:
[1] "Only one date - no plot produced"
Warning message:
