...
library(Publish)
data(Diabetes)
fit=lm(chol~age+gender,data=Diabetes)
org(fit)
#+END_SRC

#+RESULTS[<2016-11-04 16:16:30> f7dc47fec19c36837284305bb7ef9756593ba8fa]:
:RESULTS:
| Variable | Units  | Coefficient | CI.95         | p-value |
|----------+--------+-------------+---------------+---------|
| age      |        |        0.64 | [0.38;0.90]   | <0.0001 |
| gender   | female |        0.00 | [0.00;0.00]   |  1.0000 |
|          | male   |       -2.97 | [-11.57;5.64] |  0.4994 |
:END:
...
*** Calculating the dates of end of exposure, ${E}_1,\ldots, {E}_{k}$
 ...
 Note that \(D_k + R_k\) is the total prescription dose at \(T_k\) and
\(X_k\) is the estimated dose per day. Therefore \(\frac{D_{k} +
{R}_{k}}{{X}_{k}}\) is a decimal number of days. In the following,
...
#+RESULTS[<2016-11-04 16:14:49> e8dd52fbb7ab6a8eef3ca3383592ccd37dfc9dca]:
:RESULTS:
[1] "ERROR : 'at' and 'labels' lengths differ, 2 != 4"
null device 
          1
 null device 
          1
...
1 3000 125 2014-01-16 2014-01-24 0 1125 0.0000002238167 125 1 22.5 0 0  0
:END:
