...
// innerprocess
Rcpp::List innerprocess(Rcpp::DataFrame dat, Rcpp::DataFrame admdat, Rcpp::List doses, Rcpp::IntegerVector idunique, std::string drug, double N, double maxdepot, bool collapse);
RcppExport SEXP heaven_innerprocess(SEXP datSEXP, SEXP admdatSEXP, SEXP dosesSEXP, SEXP iduniqueSEXP, SEXP drugSEXP, SEXP NSEXP, SEXP maxdepotSEXP, SEXP collapseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< std::string >::type drug(drugSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(innerprocess(dat, admdat, doses, idunique, drug, N, maxdepot, collapse));
    return rcpp_result_gen;
END_RCPP
}
// Matcher
